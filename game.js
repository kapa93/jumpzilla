...
var Player = function() {
	...
	this.draw = function() {
		try {
			if (this.dir == "right") this.cy = 97;
			else if (this.dir == "left") this.cy = 185;
			else if (this.dir == "right_land") this.cy = 97;
			else if (this.dir == "left_land") this.cy = 185;
...
function Platform() {
	...
	this.draw = function() {
		try {
			...
			else if (this.type == 4 && this.state === 0) this.cy = 31;
	...
	else if (score >= 2000 && score < 5000) this.types = [2, 2, 2, 3, 3, 3, 3, 2, 2, 2, 2];
